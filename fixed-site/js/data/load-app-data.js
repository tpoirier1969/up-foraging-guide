...
import { mergeRecordLayers, normalizeRecord } from "../lib/merge.js?v=v4.3.44-r2026-05-13-plant-lookalikes-canonical1";

const APP_VERSION = new URL(import.meta.url).searchParams.get("v") || "v4.3.44-r2026-05-13-plant-lookalikes-canonical1";
