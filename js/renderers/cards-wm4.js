import { MONTH_SHORT, MONTHS } from "../constants-wm4.js?v=v2.0-wm4";
    ...
    <article class="result-card ${context === "review" ? "review-card" : ""}">
      ...
      <div class="card-main">
        <div class="card-topline">
          <a class="card-title-link" style="text-decoration:underline; text-underline-offset:2px;" href="#detail/${encodeURIComponent(record.slug)}" data-detail-link="${escapeHtml(record.slug)}">${escapeHtml(record.display_name)}</a>
