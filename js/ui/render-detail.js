...
export function renderDetail(record) {
  ...
  return `
    <article class="detail-grid">
      ...
      ${record.field_identification ? `<section class="detail-block"><h4>Field identification</h4><p>${esc(record.field_identification)}</p></section>` : ""}
      ...
      ${record.look_alike_notes ? `<section class="detail-block"><h4>Look-alike notes</h4><p>${esc(record.look_alike_notes)}</p></section>` : ""}
