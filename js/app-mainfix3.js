...
import { renderDashboard } from "./pages-mainfix3.js?v=v2.1-mainfix3";
...
const emptyFilter = (page = '') => ({ search: "", month: page === 'home' ? CURRENT_MONTH : "", habitat: "", part: "", size: "", taste: "", substrate: "", treeType: "", hostTree: "", ring: "", texture: "", smell: "", staining: "", medicinalAction: "", medicinalSystem: "", medicinalTerm: "", reviewReason: "", severity: "" });
